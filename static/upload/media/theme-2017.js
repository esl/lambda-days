...
$( "a#home" ).parent().css("background", "url('/static/s3/img/banner-tlo.jpg') no-repeat center");
$( "#call-for-papers" ).parent().css("background", "url('/static/upload/media/147610980398911callfortalkstlo.jpg')");
$( "#programme-committee" ).parent().css("background", "white");
$( "#infographic" ).parent().css("background", "url('/static/upload/media/147611161129857inforgafikatlo.jpg')");
$( "#social-banner" ).parent().css("background", "url('/static/upload/media/1476109614123702socialtlo.jpg')");
$( "#workshops" ).parent().css("background", "url('/static/upload/media/147611161129857inforgafikatlo.jpg')");
$( "#social-banner3" ).parent().css("background", "url('/static/upload/media/1476109497242936sponsorcontacttlo.jpg')");
$( "#social-banner4" ).parent().css("background", "url('/static/upload/media/1476106682499551registertlo.jpg')");
$( "#social-banner4" ).parent().css("height", "242px");
$( "#register" ).parent().css("background", "url('/static/upload/media/1476106682499551registertlo.jpg')");
